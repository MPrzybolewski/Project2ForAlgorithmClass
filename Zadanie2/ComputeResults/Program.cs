...
namespace ComputeResults
{
    class MainClass
    {
        ...
        private static void computeApBpCxX(string fileName)
        {
            ...
            double[] factorialResult1 = ReadMatrix<double>(fileName + "Factorial", 1);
            double[] factorialResult2 = ReadMatrix<double>(fileName + "Factorial", 2);
            double[] factorialResult3 = ReadMatrix<double>(fileName + "Factorial", 3);
            
            double doubleAndFactorialDiffrence = vectorNorm(doubleResult1, factorialResult1);
            double floatAndFactorialDiffrence = vectorNorm(floatResult1, factorialResult1);
